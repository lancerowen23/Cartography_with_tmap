...
credits <- tm_credits("Source: Secretaría de Salud de Mexico | Data as of 22 June 2021.", 
                      position=c(".02", ".01"),
                      fontfamily = font,
                      col = "Grey30",
                      size = .8)
...
final_map <- background + mexico + labels + layout + credits + compass + scale_bar 

final_map
png(filename = "C:/Users/psx8/Desktop/Mex_COVID.png", height=5, width=8, res=300, units="in") 
final_map
dev.off()
